...
from response_templates.frienn_template import FriennResponseForASFlow, FriennResponseForRemFlow, FriennResponseForFUFlow
...
class ChatEngine:
    ...
    def get_activity_suggestion_guidelines(self):
        ...
        return '''Activity Suggestion Guidelines:
                ...
                8. If not immediate, set a reminder.
    ...
    def generate_response(self, user_input, preferred_activities):
        ...
        print(f"{self.bot_name}:", model_response)
