...
class ActivityReminderConfig(BaseModel):
    ...
    user_situation: str = Field(description="A brief but specific description of the user's emotional or situational context when the activity is suggested (e.g., 'feeling anxious before a meeting', 'low energy in the afternoon', or 'winding down after a stressful day')")
