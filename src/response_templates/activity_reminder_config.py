...
class ActivityReminderConfig(BaseModel):
    ...
    reminder_action: str = Field(description="ENUM: `set`: to set a reminder for later, `update`:to update the remider if one is already set, `delete`:to delete the reminder")
