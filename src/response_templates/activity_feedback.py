...
class ActivityFeedback(BaseModel):
    ...
    completed: bool = Field(description="Indicates whether the user completed the activity (True) or skipped it (False). This should be determined through follow-up questions.")
